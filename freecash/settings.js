      ...
      <div class="fc-settings-tab-content" id="fc-tab-support" style="display: none;">
        <div class="fc-support-section">
          <div class="fc-support-card">
            ...
            <div class="fc-faq-item"><div class="fc-faq-question"><span class="fc-faq-question-content"><span>🔄</span> How do I reset settings?</span><span class="fc-faq-arrow">▶</span></div><div class="fc-faq-answer">Click "Reset to Defaults" in the Performance tab (soon...), or clear your browser's localStorage for this site.</div></div>
          </div>
